# Python tool to convert an image to ASCII image.
...
# gray scale level values from https://paulbourke.net/dataformats/asciiart/
...
def convertImageToAscii(fileName, cols, scale, moreLevels):
    ...
    if cols > W or rows > H:
        print("Image too small for specifications!")
        exit(0)
...
def main():
    ...
    # set scale default as 0.43 which suits Courier
    scale = 0.43
    if args.scale:
